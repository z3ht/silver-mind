...
class BoardState:
    ...
    Parameters
    ====
    :param valuator: Callable that takes serialized board as an argument and returns the winning liklihood where (-1) is
    black and (1) is white (must be provided if self does not contain a valuator)
    """
        if valuator is None:
